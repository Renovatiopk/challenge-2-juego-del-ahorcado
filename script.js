...
let predifinedWords = ['HISTORIA','EVENTOS','ITERAR','CREACION','RAZONAR','VERDAD'];
...
function drawCorrectLetter () {
    ...
    for (let index = 0; index < division.length; index++) {
        ...
        if (letter == division[index]) {       
            xinicial = xfinal + anchoEspacios;
            xfinal = xinicial + anchoLineas;
            drawLetterFunction('#0A3871', '2em Inter', letter, xinicial, yinicial);
            console.log(canvas);
            aciertos++;
        }
...
function drawWrongLetter () {
    ...
    for (let index = 0; index < division.length; index++) {
        ...
        if (letter != division[index]) {
            ...
            drawLetterFunction('#0A3871', '1.4em Inter', letter, xinicial, yinicial);
            posicionLetras++;
            break;
        }       
    }
